...
//var today = new Date();
//var launch = new Date(2014,00,28); /* zero based month */ //need a launch date
...
*/
	...
	if (Modernizr.touch)
	{
		...
		$('#buy-bluray').click({ left_position: '37px', other_menus: '#buy-menu-center,#buy-menu-right' },expand);
		$('#buy-digital').click({ left_position: '-54px', other_menus: '#buy-menu-left,#buy-menu-right' },expand);
		$('#buy-dvd').click({ left_position: '358px', other_menus: '#buy-menu-left,#buy-menu-center' },expand);
    }
	else
	{
	/* ------------------------------------------------------------------- */
     $('#buy-bluray').mouseenter({ left_position: '37px', other_menus: '#buy-menu-center,#buy-menu-right' },expand);
	...
	/* ------------------------------------------------------------------- */
	$('#buy-digital').mouseenter({ left_position: '-54px', other_menus: '#buy-menu-left,#buy-menu-right' },expand);
		$('#buy-menu-center')
	...
	/* ------------------------------------------------------------------- */
	$('#buy-dvd').mouseenter({ left_position: '358px', other_menus: '#buy-menu-left,#buy-menu-center' },expand);
